...
<div class="easyui-accordion" style="width:100%;height:auto;padding:3px;" data-options="multiple:true">
	...
	<div class="col-md-8">
		<div class="card">
			...
			<div class="card-body">
				<div class="row">
					<div class="form-group col-md-1 col-water-2" id="leftKybc">
					</div>
					<div class="form-group col-sm-12 col-md-6 col-water-4">
					...
					<div class="form-group col-sm-12 col-md-5 col-water-4" id="sandbox-container">
...
<script type="text/javascript">
    ...
    var createReportTongHop = '${sessionScope.apiContext}/report/createReportTongHop';
   	var comboKyThu=null;
	...
	$(function(){
   	...
   	function downloadFile(kyThuSearch){
        ...
        request.open('POST', createReportTongHop, true);
