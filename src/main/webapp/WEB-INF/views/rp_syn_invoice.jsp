	...
	<div align="left">
		...
		<div>
			...
			<form id="form1" method="post">
			    <table id="dg" class="easyui-datagrid" title="Danh sách dữ liệu" style="width:100%;height:400px"
		...
		<div style="padding:5px 0;width: 30%;text-align: center;margin: auto;">
			<a href="#" id="sysVni" onclick="sysVni();" class="easyui-linkbutton" data-options="iconCls:'icon-put-data'" style="width:40%">Đồng bộ VNI</a>
	        <a href="#" onclick="clearForm();" class="easyui-linkbutton" data-options="iconCls:'icon-clean'" style="width:40%">Làm mới</a>
	    </div>
    </div>
    <script type="text/javascript">
    var url_view = '${sessionScope.apiContext}/syn/viewVni';
    var url_put = '${sessionScope.apiContext}/syn/putVni';
    var listId="";
    var isReput= false;
